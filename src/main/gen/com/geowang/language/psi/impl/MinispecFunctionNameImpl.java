...
public class MinispecFunctionNameImpl extends ASTWrapperPsiElement implements MinispecFunctionName {

  public MinispecFunctionNameImpl(@NotNull ASTNode node) {
    super(node);
  }

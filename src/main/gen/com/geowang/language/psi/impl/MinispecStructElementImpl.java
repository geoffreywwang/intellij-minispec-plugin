...
public class MinispecStructElementImpl extends ASTWrapperPsiElement implements MinispecStructElement {

  public MinispecStructElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitStructElement(this);
  }

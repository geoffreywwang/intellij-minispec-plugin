...
public class MinispecStructPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecStructPrimary {

  public MinispecStructPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitStructPrimary(this);
  }
  ...
  @Override
  @NotNull
  public MinispecMemberBinds getMemberBinds() {
    return findNotNullChildByClass(MinispecMemberBinds.class);
  }

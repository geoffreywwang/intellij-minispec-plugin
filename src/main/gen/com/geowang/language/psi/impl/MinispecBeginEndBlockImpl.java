...
public class MinispecBeginEndBlockImpl extends ASTWrapperPsiElement implements MinispecBeginEndBlock {

  public MinispecBeginEndBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitBeginEndBlock(this);
  }

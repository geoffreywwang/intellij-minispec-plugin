...
public class MinispecEnumLabelValImpl extends ASTWrapperPsiElement implements MinispecEnumLabelVal {

  public MinispecEnumLabelValImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitEnumLabelVal(this);
  }

...
public class MinispecParenthesesPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecParenthesesPrimary {

  public MinispecParenthesesPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitParenthesesPrimary(this);
  }

...
public class MinispecLTRelationBinopImpl extends MinispecBinopExprImpl implements MinispecLTRelationBinop {

  public MinispecLTRelationBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitLTRelationBinop(this);
  }

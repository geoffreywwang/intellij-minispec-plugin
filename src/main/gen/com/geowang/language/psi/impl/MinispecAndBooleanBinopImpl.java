...
public class MinispecAndBooleanBinopImpl extends MinispecBinopExprImpl implements MinispecAndBooleanBinop {

  public MinispecAndBooleanBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitAndBooleanBinop(this);
  }

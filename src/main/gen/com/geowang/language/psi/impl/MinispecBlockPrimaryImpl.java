...
public class MinispecBlockPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecBlockPrimary {

  public MinispecBlockPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitBlockPrimary(this);
  }
  ...
  public MinispecBeginEndBlock getBeginEndBlock() {
    return findNotNullChildByClass(MinispecBeginEndBlock.class);
  }

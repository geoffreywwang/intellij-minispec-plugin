...
public class MinispecRegWriteImpl extends ASTWrapperPsiElement implements MinispecRegWrite {

  public MinispecRegWriteImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitRegWrite(this);
  }
  ...
  @Override
  @NotNull
  public MinispecRegName getRegName() {
    return findNotNullChildByClass(MinispecRegName.class);
  }

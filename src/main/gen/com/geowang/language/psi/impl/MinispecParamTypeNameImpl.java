...
public class MinispecParamTypeNameImpl extends ASTWrapperPsiElement implements MinispecParamTypeName {

  public MinispecParamTypeNameImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class MinispecXorLogicalBinopImpl extends MinispecBinopExprImpl implements MinispecXorLogicalBinop {

  public MinispecXorLogicalBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitXorLogicalBinop(this);
  }

...
public abstract class MinispecBinopExprImpl extends MinispecExpressionImpl implements MinispecBinopExpr {

  public MinispecBinopExprImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class MinispecEQEqualityBinopImpl extends MinispecBinopExprImpl implements MinispecEQEqualityBinop {

  public MinispecEQEqualityBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitEQEqualityBinop(this);
  }

...
public class MinispecNEQEqualityBinopImpl extends MinispecBinopExprImpl implements MinispecNEQEqualityBinop {

  public MinispecNEQEqualityBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitNEQEqualityBinop(this);
  }

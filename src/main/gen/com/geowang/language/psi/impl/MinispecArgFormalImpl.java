...
public class MinispecArgFormalImpl extends ASTWrapperPsiElement implements MinispecArgFormal {

  public MinispecArgFormalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitArgFormal(this);
  }
  ...
  @Override
  @NotNull
  public MinispecArgName getArgName() {
    return findNotNullChildByClass(MinispecArgName.class);
  }

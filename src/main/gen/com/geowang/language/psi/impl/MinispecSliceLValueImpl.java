...
public class MinispecSliceLValueImpl extends MinispecLValueImpl implements MinispecSliceLValue {

  public MinispecSliceLValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitSliceLValue(this);
  }

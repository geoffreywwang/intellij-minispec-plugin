...
public class MinispecSimpleLValueImpl extends MinispecLValueImpl implements MinispecSimpleLValue {

  public MinispecSimpleLValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitSimpleLValue(this);
  }

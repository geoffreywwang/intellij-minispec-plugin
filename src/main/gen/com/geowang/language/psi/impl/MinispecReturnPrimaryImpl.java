...
public class MinispecReturnPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecReturnPrimary {

  public MinispecReturnPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitReturnPrimary(this);
  }

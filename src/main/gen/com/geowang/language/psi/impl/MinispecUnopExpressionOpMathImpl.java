...
public class MinispecUnopExpressionOpMathImpl extends ASTWrapperPsiElement implements MinispecUnopExpressionOpMath {

  public MinispecUnopExpressionOpMathImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitUnopExpressionOpMath(this);
  }

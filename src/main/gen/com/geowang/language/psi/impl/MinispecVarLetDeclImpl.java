...
public class MinispecVarLetDeclImpl extends ASTWrapperPsiElement implements MinispecVarLetDecl {

  public MinispecVarLetDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitVarLetDecl(this);
  }

...
public class MinispecArgsImpl extends ASTWrapperPsiElement implements MinispecArgs {

  public MinispecArgsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MinispecArg> getArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MinispecArg.class);
  }

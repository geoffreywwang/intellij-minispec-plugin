...
public class MinispecExponentiationBinopImpl extends MinispecBinopExprImpl implements MinispecExponentiationBinop {

  public MinispecExponentiationBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitExponentiationBinop(this);
  }

...
public class MinispecMethodDefImpl extends ASTWrapperPsiElement implements MinispecMethodDef {

  public MinispecMethodDefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MinispecMethodName getMethodName() {
    return findNotNullChildByClass(MinispecMethodName.class);
  }

...
public class MinispecDivisionBinopImpl extends MinispecBinopExprImpl implements MinispecDivisionBinop {

  public MinispecDivisionBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitDivisionBinop(this);
  }

...
public class MinispecSubtractionBinopImpl extends MinispecBinopExprImpl implements MinispecSubtractionBinop {

  public MinispecSubtractionBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitSubtractionBinop(this);
  }

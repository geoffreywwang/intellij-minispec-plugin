...
public class MinispecTypeDefSynonymImpl extends ASTWrapperPsiElement implements MinispecTypeDefSynonym {

  public MinispecTypeDefSynonymImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitTypeDefSynonym(this);
  }

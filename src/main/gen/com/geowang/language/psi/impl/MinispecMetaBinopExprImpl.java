...
public abstract class MinispecMetaBinopExprImpl extends MinispecExpressionImpl implements MinispecMetaBinopExpr {

  public MinispecMetaBinopExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitMetaBinopExpr(this);
  }

...
public class MinispecCallPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecCallPrimary {

  public MinispecCallPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitCallPrimary(this);
  }

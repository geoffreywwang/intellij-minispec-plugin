...
public class MinispecTypeImpl extends ASTWrapperPsiElement implements MinispecType {

  public MinispecTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MinispecTypeName getTypeName() {
    return findNotNullChildByClass(MinispecTypeName.class);
  }

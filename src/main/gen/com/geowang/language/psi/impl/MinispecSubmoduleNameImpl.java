...
public class MinispecSubmoduleNameImpl extends ASTWrapperPsiElement implements MinispecSubmoduleName {

  public MinispecSubmoduleNameImpl(@NotNull ASTNode node) {
    super(node);
  }

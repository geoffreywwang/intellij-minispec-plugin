...
public class MinispecInputNameImpl extends ASTWrapperPsiElement implements MinispecInputName {

  public MinispecInputNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitInputName(this);
  }

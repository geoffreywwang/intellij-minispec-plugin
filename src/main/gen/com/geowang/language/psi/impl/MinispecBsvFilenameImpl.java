...
public class MinispecBsvFilenameImpl extends ASTWrapperPsiElement implements MinispecBsvFilename {

  public MinispecBsvFilenameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitBsvFilename(this);
  }

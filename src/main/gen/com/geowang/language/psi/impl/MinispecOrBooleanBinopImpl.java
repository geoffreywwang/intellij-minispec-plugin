...
public class MinispecOrBooleanBinopImpl extends MinispecBinopExprImpl implements MinispecOrBooleanBinop {

  public MinispecOrBooleanBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitOrBooleanBinop(this);
  }

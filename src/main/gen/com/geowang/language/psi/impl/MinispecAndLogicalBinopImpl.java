...
public class MinispecAndLogicalBinopImpl extends MinispecBinopExprImpl implements MinispecAndLogicalBinop {

  public MinispecAndLogicalBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitAndLogicalBinop(this);
  }

...
public class MinispecGEQRelationBinopImpl extends MinispecBinopExprImpl implements MinispecGEQRelationBinop {

  public MinispecGEQRelationBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitGEQRelationBinop(this);
  }

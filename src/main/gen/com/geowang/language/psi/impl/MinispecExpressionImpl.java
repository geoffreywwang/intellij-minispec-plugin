...
public abstract class MinispecExpressionImpl extends ASTWrapperPsiElement implements MinispecExpression {

  public MinispecExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class MinispecFieldPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecFieldPrimary {

  public MinispecFieldPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitFieldPrimary(this);
  }

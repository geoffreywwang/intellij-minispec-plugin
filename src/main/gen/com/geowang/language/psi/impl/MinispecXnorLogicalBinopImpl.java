...
public class MinispecXnorLogicalBinopImpl extends MinispecBinopExprImpl implements MinispecXnorLogicalBinop {

  public MinispecXnorLogicalBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitXnorLogicalBinop(this);
  }
  ...
  public PsiElement getXnor() {
    return findNotNullChildByType(XNOR);
  }

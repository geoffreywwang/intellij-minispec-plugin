...
public class MinispecLEQRelationBinopImpl extends MinispecBinopExprImpl implements MinispecLEQRelationBinop {

  public MinispecLEQRelationBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitLEQRelationBinop(this);
  }

...
public class MinispecVarElementImpl extends ASTWrapperPsiElement implements MinispecVarElement {

  public MinispecVarElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitVarElement(this);
  }
  ...
  @Override
  @NotNull
  public MinispecVarName getVarName() {
    return findNotNullChildByClass(MinispecVarName.class);
  }

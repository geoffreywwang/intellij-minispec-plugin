...
public abstract class MinispecOtherPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecOtherPrimary {

  public MinispecOtherPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitOtherPrimary(this);
  }

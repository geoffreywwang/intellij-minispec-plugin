...
public class MinispecOrLogicalBinopImpl extends MinispecBinopExprImpl implements MinispecOrLogicalBinop {

  public MinispecOrLogicalBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitOrLogicalBinop(this);
  }

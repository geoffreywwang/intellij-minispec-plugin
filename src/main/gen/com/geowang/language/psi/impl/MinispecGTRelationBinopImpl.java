...
public class MinispecGTRelationBinopImpl extends MinispecBinopExprImpl implements MinispecGTRelationBinop {

  public MinispecGTRelationBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitGTRelationBinop(this);
  }

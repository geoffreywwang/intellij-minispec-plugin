...
public class MinispecBitConcatPrimaryImpl extends MinispecPrimaryExprImpl implements MinispecBitConcatPrimary {

  public MinispecBitConcatPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitBitConcatPrimary(this);
  }

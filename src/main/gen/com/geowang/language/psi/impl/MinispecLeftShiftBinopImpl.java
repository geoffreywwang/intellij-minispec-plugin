...
public class MinispecLeftShiftBinopImpl extends MinispecBinopExprImpl implements MinispecLeftShiftBinop {

  public MinispecLeftShiftBinopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitLeftShiftBinop(this);
  }

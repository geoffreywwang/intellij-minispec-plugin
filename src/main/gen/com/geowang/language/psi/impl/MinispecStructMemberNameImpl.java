...
public class MinispecStructMemberNameImpl extends ASTWrapperPsiElement implements MinispecStructMemberName {

  public MinispecStructMemberNameImpl(@NotNull ASTNode node) {
    super(node);
  }

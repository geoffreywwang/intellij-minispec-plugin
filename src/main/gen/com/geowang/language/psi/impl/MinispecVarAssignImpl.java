...
public class MinispecVarAssignImpl extends ASTWrapperPsiElement implements MinispecVarAssign {

  public MinispecVarAssignImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MinispecLValue> getLValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MinispecLValue.class);
  }

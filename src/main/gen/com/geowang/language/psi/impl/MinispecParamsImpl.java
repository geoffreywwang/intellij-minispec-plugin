...
public class MinispecParamsImpl extends ASTWrapperPsiElement implements MinispecParams {

  public MinispecParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MinispecParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MinispecParam.class);
  }

...
public class MinispecExpressionStmtImpl extends ASTWrapperPsiElement implements MinispecExpressionStmt {

  public MinispecExpressionStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

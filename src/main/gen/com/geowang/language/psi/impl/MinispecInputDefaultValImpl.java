...
public class MinispecInputDefaultValImpl extends ASTWrapperPsiElement implements MinispecInputDefaultVal {

  public MinispecInputDefaultValImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MinispecVisitor visitor) {
    visitor.visitInputDefaultVal(this);
  }
